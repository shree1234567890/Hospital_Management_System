						...
						<form action="../updateDoctor" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Qualification</label> <input
									type="text" required  value="<%=d.getQulification()%>" name="qualification" class="form-control">
							</div>

							<div class="mb-3">
								<label class="form-label">Specialist</label> <select name="spec"
									required class="form-control">
									<option><%=d.getSpecialst() %></option>
									<%
							...
							<div class="mb-3">
								<label class="form-label">Mobile No</label> <input type="text" value="<%=d.getMobNo()%>"
									required name="mobno" class="form-control">
							</div>

							<div class="mb-3">
								<label class="form-label">Password</label> <input
									required value="<%=d.getPassword()%>" name="password" type="text" class="form-control">
							</div>
